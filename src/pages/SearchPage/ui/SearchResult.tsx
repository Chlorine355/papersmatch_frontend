...
export const SearchResult = ({ result }: { result: SearchResultType }) => {
    ...
    const plusAuthors = authors.length - 5;
    return <div className="result">
        ...
        {authors?.length ? <div className="result-property">
            <svg xmlns="http://www.w3.org/2000/svg" width="33" height="36" viewBox="0 0 33 36" fill="none">
                      <path d="M23.4083 18.5587C24.3104 17.659 25.0258 16.59 25.5134 15.4129C26.001 14.2359 26.2512 12.974 26.2496 11.7C26.2496 6.34317 21.9064 2 16.5496 2C11.1928 2 6.84961 6.34317 6.84961 11.7C6.84961 14.3788 7.9352 16.8038 9.6909 18.5587" stroke="black" strokeWidth="3" strokeLinecap="round"></path>
                      <path d="M2 34.3333L2.80833 30.2916L11.7 23.825L16.55 28.675L21.4 23.825L30.2917 30.2916L31.1 34.3333" stroke="black" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"></path>
                      <path d="M7.65234 15.7478C7.66285 12.4255 8.20363 9.99809 9.27467 8.46711C10.8816 6.17063 12.0125 6.33957 12.8354 6.69686C13.6591 7.05495 14.1433 9.39184 15.5182 10.066C16.8924 10.7393 20.4119 10.8226 21.6171 11.6333C22.8215 12.4433 25.5779 13.9508 24.8909 16.5246" stroke="black" strokeWidth="3"></path>
                    </svg>
            <span>{authors.slice(0, 5).map(author => <span key={author.authorId} className="author">{author.name}</span>)}{plusAuthors > 0 && <span className="author">+{plusAuthors}</span>}</span>
        </div> : null}
        { year && <div className="result-property">
        ...
        {fieldsOfStudy?.length && <div className="result-property">
            ...
            <span>{fieldsOfStudy.map(field => <span key={field} className="fieldOfStudy">{field}</span>)}</span>
        </div>}
        <div className="result-property">
            <svg xmlns="http://www.w3.org/2000/svg" width="31" height="31" viewBox="0 0 31 31" fill="none">
                      <path d="M2 28.598H7.69938L28.598 7.69938L22.8979 2L2 22.8986V28.598Z" stroke="black" strokeWidth="3" strokeLinejoin="round"></path>
                      <path d="M17.1992 7.69946L22.8986 13.3988" stroke="black" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"></path>
                    </svg>
